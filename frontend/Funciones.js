// // Importar el cliente API (asegúrate de que la ruta sea correcta)
// import { apiClient } from './js/api.js'; // Ajusta la ruta según tu estructura
...
//     try {
//       await apiClient.fetchAPI(`producto/${id}`, {
//         method: "DELETE"
//       });
...
//       } else {
//         // CREAR
//         await apiClient.fetchAPI("producto", {
//           method: "POST",
//           body: JSON.stringify(productoData)
//         });
//       }
